...
Конфликт слияния может произойти, если текст в разных ветках находится в одной и той же строке, или когда какой-тоКонфликт слияния может произойти, если текст в разных ветках находится в одной и той же строке, или когда какой-то файл в одной ветке удалён и отредактирован в другой.  В таком случае git не может самостоятельно его решить, предлагает выбор  файл в одной ветке удалён и отредактирован в другой.  В таком случае git не может самостоятельно его решить, предлагает выбор из нескольких вариантов, например:
